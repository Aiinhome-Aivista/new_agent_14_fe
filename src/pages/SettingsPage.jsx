        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-emerald-400 font-medium">DB Scoped</span>
            </div>
            <h3 className="text-sm font-bold text-white mt-0.5">
              {activeProject?.name || 'Enterprise Project'}
            </h3>
            <p className="text-[11px] text-slate-400">
              Jira, Azure DevOps, Google Drive, and OneDrive are saved per project in MySQL. Switching projects displays only that project's verified credentials.
            </p>
          </div>
        </div>
